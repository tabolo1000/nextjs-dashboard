    ...
    return (
        <div className="main_block_task">
            ...
            <Section title={"The Magic of Cooling: How Does a Refrigerator Create Cold?"}>
                ...
                <Interactive_Image src={schema} alt={"schema"} width={400} height={400}/>
                ...
                <ul className="unordered_list">
                    <li>
                        ...
                        <Interactive_Image src={compressor} alt={"compressor"} width={400} height={400}/>
                    </li>
                    <li>
                        ...
                        <Interactive_Image src={condenser} alt={"condenser"} width={400} height={400}/>
                    </li>
                    <li>
                        ...
                        <Interactive_Image src={capillary_tube} alt={"capillary_tube"} width={400} height={400}/>
                    </li>
                    <li>
                        ...
                        <Interactive_Image src={evaporator} alt={"evaporator"} width={400} height={400}/>
                    </li>
                    <li>
                        <Link href={`${pathWords}/coolant`}><Term>Refrigerant</Term></Link>
                        — the main substance that transfers heat in the refrigeration system.
                        <Interactive_Image src={refrigerant} alt={"refrigerant"} width={400} height={400}/>
                    </li>
                </ul>
            </Section>
