...
export default function Single_and_Two_and_Multi_digit_numbers() {
    return <div>
        <section className="mb-8">
            <h2 className="text-2xl font-semibold mb-4 text-blue-600">6. Однозначные и двузначные числа</h2>
            <p className="mb-4">
        ...
        <section className="mb-8">
            <h2 className="text-2xl font-semibold mb-4 text-blue-600">7. Многозначные числа</h2>
            <p className="mb-4">
